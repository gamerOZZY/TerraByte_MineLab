...
## Project Overview
This project is an end-to-end data platform developed as a personal laboratory to explore and demonstrate skills in Data Engineering, Data Science, and Business Intelligence.
